...
import {
  ...
  Description,
  Button,
} from "../styles/CollectionShowcase";
...
function CollectionShowcase() {
  ...
  return (
    <Container>
      <Card>
        <Image src="images/collection1.jpg" alt="Golden Charm" />
        <Title>{t("item1.title")}</Title>
        <Description>{t("item1.description")}</Description>
        <Button>
          <Link href={`/${currentLocale}/product`}>{t("learnMore")}</Link>
        </Button>
      </Card>

      <Card>
        <Image src="images/collection2.avif" alt="Golden Charm" />
      ...
      <Card>
        <Image src="images/collection3.avif" alt="Golden Charm" />
